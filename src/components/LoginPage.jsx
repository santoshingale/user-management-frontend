...
const LoginPage = ({ handleLogin, isAuthenticated }) => {
            ...
            <div className="container">
                <div className="form_container ">
                    <div className="login_form">
                        ...
                        <div className="forgetpass"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-lock-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
